...
ALTER TABLE IF EXISTS person_data
    ...
    create sequence medical_inst.address_id_seq owned by medical_inst.address.id;
    alter table medical_inst.address alter column id set default nextval('medical_inst.address_id_seq');
    update medical_inst.address set id = nextval('medical_inst.address_id_seq');

    create sequence medical_inst.illness_id_seq owned by medical_inst.illness.id;
    alter table medical_inst.illness alter column id set default nextval('medical_inst.illness_id_seq');
    update medical_inst.illness set id = nextval('medical_inst.illness_id_seq');

    create sequence medical_inst.medical_card_id_seq owned by medical_inst.medical_card.id;
    alter table medical_inst.medical_card alter column id set default nextval('medical_inst.medical_card_id_seq');
    update medical_inst.medical_card set id = nextval('medical_inst.medical_card_id_seq');

    create sequence medical_inst.person_data_id_seq owned by medical_inst.person_data.id;
    alter table medical_inst.person_data alter column id set default nextval('medical_inst.person_data_id_seq');
    update medical_inst.person_data set id = nextval('medical_inst.person_data_id_seq');
